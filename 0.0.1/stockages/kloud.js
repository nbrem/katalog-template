...
function htmlTitleKloudGenerator(content) {   
    ...
    let html = `<br>
                <h1 style="display: block;">
                    <img style="float:right;margin:15px 50px;" width="95px" class="fit-picture" src="https://cdn-icons-png.flaticon.com/512/3176/3176377.png" alt="Kloud logo">
                    ` + data[1][0] + `
                    <br><br><p style="color:#AAA; font-size: 18px; font-weight: 350;">` + data[1][1] + `</p>
                </h1>`;  
